...
### Algorithms
- Freidling, T., Poignard, B., Climente-González, H., Yamada, M., [Post-selection inference with HSIC-Lasso.](https://arxiv.org/pdf/2010.15659.pdf) ICML 2021.
- Huang, Q., Yamada, M., Tian, Y., Singh, D., Chang, Y., [GraphLIME: Local Interpretable Model Explanations for Graph Neural Networks](https://arxiv.org/pdf/2001.06216.pdf). arXiv 2020. (**Google scholar citations: 38** as of 2021/6/25)
